  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-headline-md font-bold text-ink dark:text-ink">Employees</h1>
          <p className="text-body-md text-ink-variant dark:text-ink-variant mt-1">Manage your organization&apos;s workforce</p>
        </div>
        ...
        <div className="bg-surface rounded-xl border border-border p-4 flex flex-wrap gap-4">
          <div>
            ...
            <select
              ...
              className="px-3 py-2 rounded-lg border border-border bg-surface-sunken-lowest dark:bg-surface-sunken-lowest text-ink text-sm outline-none"
            >
      ...
      {employees && employees.length > 0 && (
        <div className="text-sm text-ink-variant dark:text-ink-variant text-center">
