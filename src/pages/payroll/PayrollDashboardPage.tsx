    ...
    <div className="space-y-6 max-w-6xl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-body-md text-ink-muted mt-1">Overview of payroll costs, approvals, and recent runs</p>
        </div>
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-ink-muted">Total Paid (YTD)</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {summary?.pendingTotal ? (
                  <p className="text-xs text-ink-muted">{fmt(summary.pendingTotal)} THB</p>
                ) : null}
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-ink-muted">Last Run Net</p>
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-ink-muted">Active Cycles</p>
      ...
      <Card>
        ...
        <CardContent>
          {summary?.recentRuns.length === 0 ? (
            <p className="text-sm text-ink-muted text-center py-6">No payroll runs yet.</p>
          ) : (
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left py-2 px-3 text-ink-muted font-medium">Date</th>
                    <th className="text-left py-2 px-3 text-ink-muted font-medium">Status</th>
                    <th className="text-right py-2 px-3 text-ink-muted font-medium">Gross</th>
                    <th className="text-right py-2 px-3 text-ink-muted font-medium">Deductions</th>
                    <th className="text-right py-2 px-3 text-ink-muted font-medium">Net</th>
