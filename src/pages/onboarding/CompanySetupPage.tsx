    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-sunken p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          ...
          <p className="text-body-md text-ink-muted mt-2">{t('company.setup_subtitle')}</p>
        </div>
        <div className="bg-surface rounded-xl border border-border p-6 shadow-sm">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              <label className="block text-label-md text-ink-muted mb-1">{t('company.name')}</label>
            ...
            <div>
              <label className="block text-label-md text-ink-muted mb-1">{t('company.name_th')}</label>
            ...
            <div>
              <label className="block text-label-md text-ink-muted mb-1">{t('company.industry')}</label>
            ...
            <div>
              <label className="block text-label-md text-ink-muted mb-1">{t('company.country')}</label>
            ...
            <div>
              <label className="block text-label-md text-ink-muted mb-1">{t('company.tax_id')}</label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-label-md text-ink-muted mb-1">{t('company.phone')}</label>
                <input {...register('phone')} type="tel"
                  className="w-full px-3 py-2 rounded-lg border border-border bg-surface-sunken-lowest focus:border-primary focus:ring-1 focus:ring-primary outline-none" />
              </div>
              <div>
                <label className="block text-label-md text-ink-muted mb-1">{t('company.email')}</label>
