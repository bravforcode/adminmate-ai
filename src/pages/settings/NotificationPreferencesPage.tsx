...
export function NotificationPreferencesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link to="/settings" className="inline-flex items-center gap-1 text-sm text-ink-muted hover:text-primary mb-3">
        ...
        <p className="text-body-md text-ink-muted mt-1">{t('notifications_prefs.subtitle') || 'Choose how you want to be notified'}</p>
      </div>
      ...
      <div className="bg-surface rounded-xl border border-border shadow-sm p-6">
        ...
        <div className="grid grid-cols-12 text-xs font-medium text-ink-muted mb-3 px-1">
            ...
            return (
              <div key={type} className="grid grid-cols-12 items-center py-4 px-1 gap-2">
                <div className="col-span-5 sm:col-span-4">
                  ...
                  <div className="text-xs text-ink-muted mt-0.5">{t(descKey) || ''}</div>
                </div>
                <div className="col-span-1 flex justify-center">
                  <Smartphone size={14} className="text-ink-muted hidden sm:block" />
                </div>
                <div className="col-span-3 sm:col-span-2 flex justify-center">
                  <div className="flex items-center gap-2">
                    <Mail size={14} className="text-ink-muted hidden sm:block" />
                    <Toggle
