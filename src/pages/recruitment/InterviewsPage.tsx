  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-body-md text-ink-muted text-ink-muted mt-1">{t('interviews.subtitle')}</p>
      </div>
      ...
      <div className="flex gap-1 bg-surface-sunken rounded-lg p-1 w-fit">
        <button
          ...
          className={cn(
            ...
            tab === 'upcoming' ? 'bg-surface shadow-sm text-ink text-ink' : 'text-ink-muted text-ink-muted hover:text-ink dark:hover:text-ink'
          )}
        >
        ...
        <button
          ...
          className={cn(
            'px-4 py-2 rounded-md text-sm font-medium transition-colors',
            tab === 'past' ? 'bg-surface shadow-sm text-ink text-ink' : 'text-ink-muted text-ink-muted hover:text-ink dark:hover:text-ink'
          )}
        >
