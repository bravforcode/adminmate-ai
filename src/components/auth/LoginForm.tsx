    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-3 py-2 rounded-lg border border-border bg-surface focus:border-primary focus:ring-2 focus:ring-primary/15 outline-none transition-all duration-150 pr-10 text-ink placeholder:text-ink-faint"
      ...
      <div className="relative my-5">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-3 bg-surface text-ink-muted">{t('auth.or')}</span>
        </div>
      </div>
