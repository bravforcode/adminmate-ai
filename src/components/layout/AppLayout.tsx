...
export function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-surface-sunken flex">
      ...
      <Sidebar />
      <div className="flex-1 flex flex-col min-h-screen md:sidebar-offset">
        <Header />
        <main id="main-content" role="main" className="flex-1 px-4 md:px-6 pt-12 pb-[max(72px,env(safe-area-inset-bottom))] md:pb-6 max-w-[1280px] mx-auto w-full overflow-y-auto">
          <Outlet />
        </main>
      </div>
      <MobileNav />
