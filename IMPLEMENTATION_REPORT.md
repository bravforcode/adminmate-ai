...
### Tests (4 new files, 21 tests)
- `tests/unit/services/permissionService.test.ts` (8 tests)
- `tests/unit/services/sensitiveFieldService.test.ts` (4 tests)
- `tests/unit/services/featureFlagService.test.ts` (6 tests)
